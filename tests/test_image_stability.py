...
class TestStabilityAI(unittest.TestCase):
    ...
    def test_call_stability_with_parameters(self, mock_post):
        ...
        mock_response.json.return_value = {
            'artifacts': [
                {
                    'base64': base64.b64encode(b'test_image_data').decode('utf-8')
                }
            ]
        }
        ...
        self.assertEqual(args[0], "https://api.stability.ai/v1/generation/stable-diffusion-xl-1024-v1-0/text-to-image")
